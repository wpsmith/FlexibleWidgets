...
if ( ! class_exists( __NAMESPACE__ . '\ParallaxHalvesWidgetArea' ) ) {
	class ParallaxHalvesWidgetArea  extends ParallaxFlexibleWidgetArea {

		protected $type = 'parallax-halves';
		...
		public function do_widget_area( $classes = array() ) {
			...
			$widget_area = new HalvesWidgetArea( $this->id );

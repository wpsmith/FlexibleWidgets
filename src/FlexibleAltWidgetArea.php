...
if ( ! class_exists( __NAMESPACE__ . '\FlexibleAltWidgetArea' ) ) {
	class FlexibleAltWidgetArea extends FlexibleWidgetArea {

		protected $type = 'flexible-alt';
		protected $classes = array( 'flexible-widget-area', 'alternate' );
